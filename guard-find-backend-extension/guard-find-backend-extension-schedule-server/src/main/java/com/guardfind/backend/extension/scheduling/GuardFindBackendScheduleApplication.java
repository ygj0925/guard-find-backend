...
package com.guardfind.backend.extension.scheduling;
...
public class GuardFindBackendScheduleApplication extends com.aizuda.snailjob.server.SnailJobServerApplication implements ApplicationRunner {

    private final ServerProperties serverProperties;

    public static void main(String[] args) {
        SpringApplication.run(GuardFindBackendScheduleApplication.class, args);
    }
    ...
    public void run(ApplicationArguments args) {
        ...
        log.info("注意: 此服务是 Guard Find Backend 的独立 Snail Job 调度服务。");
        log.info("------------------------------------------------------");
    }
}
