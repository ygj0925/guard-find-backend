...
VALUES
(1, 'SITE', '系统名称', 'SITE_TITLE', NULL, 'Guard Find Backend', '显示在浏览器标题栏和登录界面的系统名称'),
(2, 'SITE', '系统描述', 'SITE_DESCRIPTION', NULL, '持续迭代优化的前后端分离中后台管理系统框架', '用于 SEO 的网站元描述'),
(3, 'SITE', '版权声明', 'SITE_COPYRIGHT', NULL, 'Copyright © 2022 - present Guard Find Backend 版权所有', '显示在页面底部的版权声明文本'),
...
VALUES
(1, '开发环境', 'local_dev', 1, NULL, NULL, NULL, 'C:/guard-find-backend/data/file/', 'http://localhost:8000/file/', true, '.RECYCLE.BIN/', '本地存储', true, 1, 1, 1, NOW()),
(2, '生产环境', 'local_prod', 1, NULL, NULL, NULL, '../data/file/', 'http://admin-api.guard-find.local/file/', true, '.RECYCLE.BIN/', '本地存储', false, 2, 2, 1, NOW());
