...
@EnableFileStorage
@EnableMethodCache(basePackages = "com.guardfind.backend")
@EnableFeignClients
@RestController
@SpringBootApplication
@RequiredArgsConstructor
public class GuardFindBackendApplication implements ApplicationRunner {
    ...
    public static void main(String[] args) {
        ...
        SpringApplication application = new SpringApplication(GuardFindBackendApplication.class);
    ...
    public void run(ApplicationArguments args) {
        ...
        log.info("Guard Find Backend: 管理后台服务已启动");
        log.info("--------------------------------------------------------");
    }
}