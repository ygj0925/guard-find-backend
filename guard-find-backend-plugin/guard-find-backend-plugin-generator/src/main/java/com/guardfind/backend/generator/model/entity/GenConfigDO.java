...
package com.guardfind.backend.generator.model.entity;
...
public class GenConfigDO implements Serializable {
     ...
     * 模块名称
     */
    @Schema(description = "模块名称", example = "guard-find-backend-system")
     ...
     * 包名称
     */
    @Schema(description = "包名称", example = "com.guardfind.backend.system")
