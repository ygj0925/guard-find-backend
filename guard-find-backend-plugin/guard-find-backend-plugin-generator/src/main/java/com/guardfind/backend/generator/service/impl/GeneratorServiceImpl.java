...
package com.guardfind.backend.generator.service.impl;
...
import com.guardfind.backend.generator.config.properties.GeneratorProperties;
import com.guardfind.backend.generator.enums.FormTypeEnum;
import com.guardfind.backend.generator.enums.QueryTypeEnum;
import com.guardfind.backend.generator.mapper.FieldConfigMapper;
import com.guardfind.backend.generator.mapper.GenConfigMapper;
import com.guardfind.backend.generator.model.entity.FieldConfigDO;
import com.guardfind.backend.generator.model.entity.GenConfigDO;
import com.guardfind.backend.generator.model.entity.InnerGenConfigDO;
import com.guardfind.backend.generator.model.query.GenConfigQuery;
import com.guardfind.backend.generator.model.req.GenConfigReq;
import com.guardfind.backend.generator.model.resp.GeneratePreviewResp;
import com.guardfind.backend.generator.service.GeneratorService;
...
public class GeneratorServiceImpl implements GeneratorService {
        ...
        try {
            ...
            tableNames.forEach(tableName -> {
                ...
                for (GeneratePreviewResp generatePreview : generatePreviewList) {
                    // 后端：guard-find-backend/guard-find-backend-system/src/main/java/top/continew/admin/system/service/impl/XxxServiceImpl.java
                    // 前端：guard-find-backend/guard-find-backend-ui/src/views/system/user/index.vue
                    File file = new File(projectPath + generatePreview.getPath()
                        .replace("guard-find-backend\\guard-find-backend", ""), generatePreview.getFileName());
                    // 如果已经存在，且不允许覆盖，则跳过
    ...
    private void setPreviewPath(GeneratePreviewResp generatePreview,
        ...
        if (generatePreview.isBackend()) {
            // 例如：guard-find-backend/guard-find-backend-system/src/main/java/top/continew/admin/system/service/impl
            ...
            // 例如：guard-find-backend/guard-find-backend-ui/src/views/system
            ...
            // 例如：guard-find-backend/guard-find-backend-ui/src/views/system/user
    ...
    private String buildBackendBasicPackagePath(GenConfigDO genConfig,
                                                GeneratorProperties.TemplateConfig templateConfig) {
        String extension = templateConfig.getExtension();
        // 例如：guard-find-backend/guard-find-backend-system/src/main/java/top/continew/admin/system
