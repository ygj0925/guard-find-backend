...
package com.guardfind.backend.generator.model.resp;
...
public class GeneratePreviewResp implements Serializable {
    ...
    @Schema(description = "生成的文件路径", example = "guard-find-backend\\guard-find-backend\\guard-find-backend-generator\\src\\main\\java\\top\\continew\\admin\\generator\\service")
    private String path;
