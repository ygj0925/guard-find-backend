...
package com.guardfind.backend.schedule.model.resp;

import io.swagger.v3.oas.annotations.media.Schema;
import lombok.Data;
import com.guardfind.backend.schedule.enums.JobExecuteReasonEnum;
import com.guardfind.backend.schedule.enums.JobExecuteStatusEnum;
...
public class JobLogResp implements Serializable {
     ...
     * 任务组
     */
    @Schema(description = "任务组", example = "guard-find-backend")
