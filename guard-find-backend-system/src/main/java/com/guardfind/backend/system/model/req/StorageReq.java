...
package com.guardfind.backend.system.model.req;
...
import com.guardfind.backend.system.validation.ValidationGroup;
...
public class StorageReq implements Serializable {
     ...
     * Bucket/存储路径
     */
    @Schema(description = "Bucket/存储路径", example = "guard-find-backend")
     ...
     * 域名/访问路径
     */
    @Schema(description = "域名/访问路径", example = "https://files.admin.guard-find.local/")
