...
package com.guardfind.backend.system.model.resp.log;
...
public class LogDetailResp implements Serializable {
     ...
     * 请求 URL
     */
    @Schema(description = "请求 URL", example = "http://admin-api.guard-find.local/system/dept")
     ...
     * 请求头
     */
    @Schema(description = "请求头", example = "{\"Origin\": [\"https://admin.guard-find.local\"],...}")
